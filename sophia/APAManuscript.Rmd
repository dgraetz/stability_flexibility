...
(write more about our model comparisons decision-tree procedure and how our final models for these ended up looking)
...
Individual‑differences analyses of the dependent variable were conducted using linear regression modeling. For each participant, drift rate was computed as a function of switch condition and previous and current group‑valence conditions (eight estimates per subject).
