...
The behavior of these models can be described within an ``attractor landscape'' (Brown, Reynolds, \& Braver, 2007; Geddert \& Egner, 2022). In this framework, different task representations form basins in a state space, and the depth of a basin reflects how strongly a task is currently activated.
...
\pandocbounded{\includegraphics[keepaspectratio]{sophia/predmodels.png}}
...
This increased stability should then make switching on the next trial harder, producing larger switch costs. Indeed, much of the dominant narrative in cognitive control has been built around this tradeoff pattern (Goschke, 2000b).
Yet, there are also several recent results that call the generalizability of this finding into question (Brown et al., 2007; Geddert \& Egner, 2022; Mayr et al., 2014).
